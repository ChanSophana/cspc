...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="/" class="logo"><b>CS<span>PC</span></b></a>
      <!--logo end-->
        ...
        @else
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                    ...
                    <a class="centered dropdown-item" href="{{ route('logout') }}"
  ...
  <script src="{{ URL::asset("assets/lib/jquery-ui-1.9.2.custom.min.js")}}"></script>
  <script src="{{ URL::asset("assets/lib/jquery.ui.touch-punch.min.js")}}"></script>
  <script class="include" type="text/javascript" src="{{ URL::asset("assets/lib/jquery.dcjqaccordion.2.7.js")}}"></script>
  <script src="{{ URL::asset("assets/lib/jquery.scrollTo.min.js")}}"></script>
  <script src="{{ URL::asset("assets/lib/jquery.nicescroll.js")}}" type="text/javascript"></script>
  <!--common script for all pages-->
  <script src="{{ URL::asset("assets/lib/common-scripts.js")}}"></script>
